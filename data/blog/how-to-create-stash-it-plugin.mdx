...
1. Method is called.
   ...
   It expects `key`, `value` and optional `extra` arguments.
...
1. Connection to storage is established.
   ...
   Depending on where you will be storing the data, adapter might do
...
1. The `beforeSetItem` hook gets called (thus executing any registered hook hanlers).
