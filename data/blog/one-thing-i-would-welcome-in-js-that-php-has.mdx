...
hard to find the best one. It's not about the language itself. On top of that, there are very few standards and best practices.
Or modules that work together through interfaces (not concrete implementations).
...
But according to my current knowledge there is no such thing 😞 I wish there was.
