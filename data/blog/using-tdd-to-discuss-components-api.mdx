...
It was great as people saw what the client was supposed to be doing (test description), how it is working (test implementation).
They were not interested how it is done (client implementation, which was not done), as it's irrelevant.
