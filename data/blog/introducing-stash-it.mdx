...
if you want to use a storage that is not supported yet. As all of them share the same interface, you can also
easily change the storage without changing the code that uses it (given it is accessible in given environment).
