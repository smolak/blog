---
title: "Using language of the domain to keep things in order"
date: '2024-03-02'
...
One of the assignment I had to tackle included refactoring a part of the code, where a list of products was rendered.
...
Here's an example how this code should look like:
...
comes as the last piece. There were discussions, plannings, decisions made long before that. People coined names or used
