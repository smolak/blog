...
Remember, you don't have to spend lots of time coming up with perfect names. Just write good enough names.
When you'll revisit the code later, you will see if the name can be improved.
